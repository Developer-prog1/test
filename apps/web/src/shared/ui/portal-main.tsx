 ...
 * matches the sidebar (`header-height + 0.85rem`), so list items fade
 * under a top mask before the floating header — buttons stay clear of
 * the header’s dark glass.
 */
    ...
    <div className="lg:pl-[calc(var(--admin-sidebar-width)+0.75rem)]">
      <div
        className="
          ...
          lg:top-[calc(var(--header-height)+0.85rem)]
          lg:overflow-hidden lg:px-0 lg:py-0
        "
      >
        <div
          aria-hidden
          className="pointer-events-none absolute inset-x-0 top-0 z-20 hidden h-16 bg-gradient-to-b from-[var(--bg)] from-55% via-[color-mix(in_srgb,var(--bg)_65%,transparent)] to-transparent lg:block"
        />
        <div
          data-portal-scroll
